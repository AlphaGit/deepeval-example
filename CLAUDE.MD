...
4. **Claude must always ask for permission before committing** - never commit without explicit user approval
5. Once user approves without feedback, Claude commits the changes to the repository
